...
axios.interceptors.request.use(function (config) {
    ...
    // config.headers.token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFqIiwiX2lkIjoiNWYwNmFlMTM3NjZkZWU0NjBjZTQyODc4IiwiaWF0IjoxNTk0MjczMzA4LCJleHAiOjE1OTQzNTk3MDh9.REiaTSgMUZvbPbIbaOhi6cHjJUuqrYYpukFGdX86Oa4"
    // 每次都自动携带token
    // console.log(config);
